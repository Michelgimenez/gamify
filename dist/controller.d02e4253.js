...
})({"6acf40a202d7d556ab1e11e25d9076ae":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "d02e4253bfaa928227c2b6bacdab329e";
...
},{}],"e2c99d933040f3c8818a5867b9d3ffcc":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"27c2b6bacdab329e\":\"controller.d02e4253.js\",\"083dcee825afa663\":\"icons.6ee87acd.svg\"}"));
...
// Para pasar el async/await a es5
...
const controlRecipes = async function () {
  try {
    ...
    const idString = window.location.hash.slice(1); // Lo paso a numero ya que en model.js donde llamo a loadRecipe si le mando el id sin pasar a numero va a ser una string, y no puedo comparar una string con un numero a la hora de verificar si el juego esta marcado como favorito en el state de bookmarked que contiene el ID en numero del juego

    const id = Number(idString);
    if (!id) return;

    _recipeView.default.renderSpinner(); // 0) Al hacerle click a una receta, se ejecuta controlRecipes, asi que procedo a lanzar este metodo, que se ejecuta en View.js, y que termina en _generateMarkUpPreview dentro de resultsView.js, donde se actualiza la class de la receta a la que le hice click, de esa forma queda seleccionada.


    _resultsView.default.update(model.getSearchResultsPage()); // 1) Procedo a llamar a update sobre la view de bookmark, para que cuando este renderizando una receta y le haga bookmark, al fijarme los bookmark, va a estar coloreada la receta que tengo renderizada (la que estoy viendo sus ingredientes, etc)


    _bookmarksView.default.update(model.state.bookmarks); // 2) Cargando recipiente


    await model.loadRecipe(id); // 3) Renderizando recipiente
...
const controlSearchResults = async function () {
  try {
    _resultsView.default.renderSpinner(); // 1) Obtengo el query del url


    const query = _searchView.default.getQuery();

    if (!query) return; // 2) Obtengo las recetas de la busqueda

    await model.loadSearchResults(query); // 3) Renderizo las recetas

    _resultsView.default.render(model.getSearchResultsPage()); // 4) Renderizo la paginacion
...
const controlAddBookmark = function () {
  ...
  if (!model.state.recipe.bookmarked) model.addBookmark(model.state.recipe);else model.removeBookmark(model.state.recipe.id); // 2) Actualizo la UI mostrando el icono de bookmark relleno o vacio

  _recipeView.default.update(model.state.recipe); // 3) Renderizo los bookmarks
...
exports.removeBookmark = exports.addBookmark = exports.getSearchResultsPage = exports.loadSearchResults = exports.loadRecipe = exports.state = void 0;
...
const createRecipeObject = async function (data) {
  const game = data;
  const imagesResponse = await fetch(`https://api.rawg.io/api/games/${game.id}/screenshots`);
  const {
    results: images
...
const loadRecipe = async function (id) {
  try {
    ...
    console.error(`${error} 🧨🧨`); // Lanzo el error para que lo pueda atrapar por ejemplo en controlRecipes de controller.js, que es donde se llama a esta funcion
...
const addBookmark = function (recipe) {
  ...
  state.bookmarks.push(recipe); // 2) Marco la receta como bookmarked. Si el id de la receta recibida en esta funcion, es igual al id de la receta que me encuentro viendo y que almacene en el state. Entonces a esta receta en el state le agrego el field de bookmarked y le coloco TRUE.
...
const removeBookmark = function (id) {
  const index = state.bookmarks.findIndex(recipebookmarked => recipebookmarked.id === id);
...
init(); // SI QUIERO ELIMINAR TODOS LOS BOOKMARKS DE UNA, SIMPLEMENTE SACO ESTOS COMENTARIOS Y DEJO LA LLAMADA A "INIT", COMENTADA
...
exports.RESULTS_PER_PAGE = exports.MODAL_CLOSE_SEC = exports.TIMEOUT_SECONDS = exports.KEY = exports.API_URL_GAME_DETAILS = exports.API_URL = void 0;
const API_URL = 'https://api.rawg.io/api/games?';
exports.API_URL = API_URL;
const API_URL_GAME_DETAILS = 'https://api.rawg.io/api/games/';
exports.API_URL_GAME_DETAILS = API_URL_GAME_DETAILS;
const KEY = '662a1dd6297e4072a206dfb41d53e8b6';
exports.KEY = KEY;
...
const AJAX = async function (url) {
  try {
    const fetchPro = fetch(url); // Aca uso race para consumir la promesa que se cumpla primero, llamando a la funcion que si pasan 6 segundos sin que se cumpla primero el fetch, entonces procedo a lanzar un error que atrapo con el catch y lo lanzo para que lo atrape por ejemplo loadRecipe()

    const res = await Promise.race([timeout(_config.TIMEOUT_SECONDS), fetchPro]);
    const data = await res.json(); // if (!res.ok) throw new Error(`${data.message} (status ${data.status})`);
...
class RecipeView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", "We couldn't find the recipe that you are looking for. Please try another one!");
  ...
  _generateMarkUp() {
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            ...
            <span class="recipe__info-data recipe__info-data--minutes">${this._data.released}</span>
          </div>
          <div class="recipe__info">
          <ion-icon name="star-outline" class="recipe__info-icon md hydrated"></ion-icon>
            <span class="recipe__info-data recipe__info-data--people">${this._data.rating}</span> 
          </div>
          <div class="recipe__info">
          <ion-icon name="business-outline" class="recipe__info-icon md hydrated"></ion-icon>
            <span class="recipe__info-data recipe__info-data--people">${this._data.developers[0].name}</span> 
          </div>
          <div class="recipe__info">
          <ion-icon name="game-controller-outline" class="recipe__info-icon md hydrated"></ion-icon>
            <span class="recipe__info-data recipe__info-data--people">${this._data.genres.map(genre => {
      return genre.name;
    }).join(', ')}</span> 
          </div>
        ...
        <div class="recipe__ingredients">
          ...
          <ul class="recipe__ingredient-list">
            ${this._data.description ? this._data.description : '<h2> No pudimos encontrar una descripcion de este videojuego</h2>'}   
      ...
      return `<img src=${image.image} class="recipe__images-list-image"> </img>`;
        ...
        <div class="recipe__video">
          ...
          Video</h2>
          ${this._data.video ? `<video class="recipe__video-view" autoplay muted loop controls>
          <source src=${this._data.video}></source>` : 'Este juego no tiene video'}
          </video>
        </div>
        ...
        <div class="recipe__directions">
          ...
          ${this._data.stores.length !== 0 ? this._data.stores.map(store => {
      return `<a
    ...
    }).join('') : '<h2> No pudimos encontrar una tienda que venda este videojuego</h2>'}
          </div>
        </div>
    `;
  }
...
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"61b7a1b097e16436be3d54c2f1828c73":[function(require,module,exports) {
"use strict";
...
class View {
  constructor() {
    ...
    _defineProperty(this, "_window", document.querySelector('.add-game-window'));

    _defineProperty(this, "_overlay", document.querySelector('.overlay-2'));

    _defineProperty(this, "_btnClose", document.querySelector('.btn--close-img-modal'));
  }
  ...
  update(data) {
    ...
    newElements.forEach((newEl, i) => {
      const curEl = currentElements[i]; // console.log(newEl.isEqualNode(curEl));
...
},{"url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"1ba72a9b679aff6d2e6f7fea54f72dff":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("27c2b6bacdab329e", "083dcee825afa663");
...
class ResultsView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", 'No se encontraron video juegos para tu busqueda, por favor busque algo como Final Fantasy VII remake 🎮');

    _defineProperty(this, "_message", '');
  }

  _generateMarkUp() {
    return this._data.map(game => _previewView.default.render(game, false)).join('');
  }
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","./previewView.js":"e4d6583325a8b6c9380670c4f233bf07","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"e4d6583325a8b6c9380670c4f233bf07":[function(require,module,exports) {
"use strict";
    ...
    return `
      ...
      <a class="preview__link ${this._data.id === id ? 'preview__link--active' : ''}" href="#${this._data.id}">
        ...
        <div class="preview__data">
          ...
          <p class="preview__publisher">${this._data.genres.map(genre => {
      return genre.name;
    }).join(', ')}</p>
        </div>
      </a>
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"d2063f3e7de2e4cdacfcb5eb6479db05":[function(require,module,exports) {
"use strict";
...
class PaginationView extends _View.default {
  ...
  _generateMarkUp() {
    ...
    const numPages = Math.ceil(this._data.results.length / this._data.resultsPerPage); // Si estoy en la pagina 1 y hay otras paginas
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"7ed9311e216aa789713f70ebeec3ed40":[function(require,module,exports) {
"use strict";
...
class BookmarksView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", 'Todavia no agregaste ningun juego a favoritos 😋');
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","./previewView.js":"e4d6583325a8b6c9380670c4f233bf07","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}],"a5e12da10e612d232ac310f0aff6cad6":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"1ba72a9b679aff6d2e6f7fea54f72dff"}]},{},["6acf40a202d7d556ab1e11e25d9076ae","e2c99d933040f3c8818a5867b9d3ffcc","175e469a7ea7db1c8c0744d04372621f"], null)

//# sourceMappingURL=controller.d02e4253.js.map
